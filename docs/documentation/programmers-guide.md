...
* ## How Metadata relates to Generated HTML
  ...
  * Example of a Widget Metadata: 
    ...
    Causes the generation of the following Markup.  The actual shape of the generated markup is controlled by the library but a number of  options exist to influence how things get rendered.  Some widgets like drop downs,  select boxes, etc generate larger amounts of markup.  Most of this developers guide involves showing you how to control how the system renders content and how you can control it to meet your specific needs.
